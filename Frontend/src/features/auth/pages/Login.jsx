...
import { Mail, Lock, Brain, ArrowLeft, Loader2 } from 'lucide-react'
...
const Login = () => {
    ...
    return (
        <div className="relative min-h-screen bg-zinc-950 text-zinc-50 flex flex-col justify-center items-center px-4 overflow-hidden font-sans">
            {/* Background Glows */}
            <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-violet-600/10 blur-[130px] pointer-events-none" />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-zinc-400 text-sm mt-1">Sign in to resume your interview prep</p>
                </div>
                ...
                <div className="glass-panel rounded-2xl p-8 shadow-xl border border-zinc-800/80">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full inline-flex items-center justify-center rounded-xl bg-white hover:bg-zinc-200 text-zinc-950 py-3 text-sm font-semibold transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
                        >
                            {loading ? (
                                <>
                    ...
                    <div className="mt-6 text-center text-sm">
                        ...
                        <Link to="/register" className="text-violet-400 hover:text-violet-300 font-medium hover:underline underline-offset-4">
                            Register
                        </Link>
                    </div>
                </div>
